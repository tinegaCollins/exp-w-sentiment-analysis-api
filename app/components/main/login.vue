        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl">Sign in to Review Central</h2>
                    <p class="mt-2 text-base text-gray-600">Don’t have an account? <span @click="SignUp"
                            class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 hover:cursor-pointer focus:text-blue-700 hover:underline">Create
                            a free account</span></p>
                        ...
                        <div class="space-y-5">
                            <div>
                                ...
                                <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                    ...
                                    <input type="email" name="" id="AWERFEW" v-model="company.email"
                            ...
                            <div>
                                ...
                                <div class="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                    ...
                                    <input type="password" name="" id="RSTGRT" placeholder="Enter your password"
